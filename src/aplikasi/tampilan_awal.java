...
public class tampilan_awal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("APLIKASI PENEMPATAN SISWA PKL");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplikasi/logo smkn 1 negara.png"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(697, 545));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        tampilan_daftar td = new tampilan_daftar();
        td.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        tampilan_login l = new tampilan_login();
        l.setVisible(true);
        this.dispose();
